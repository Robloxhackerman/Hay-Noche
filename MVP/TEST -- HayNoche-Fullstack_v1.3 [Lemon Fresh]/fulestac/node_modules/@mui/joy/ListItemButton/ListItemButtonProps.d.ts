...
export type ListItemButtonProps<D extends React.ElementType = ListItemButtonTypeMap['defaultComponent'], P = {
...
export type ExtendListItemButton<M extends OverridableTypeMap> = ((props: OverrideProps<ExtendListItemButtonTypeMap<M>, 'a'>) => JSX.Element) & OverridableComponent<ExtendListItemButtonTypeMap<M>>;
