...
const ListDivider = /*#__PURE__*/React.forwardRef(function ListDivider(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(ListDividerRoot
  // @ts-ignore
  , (0, _extends2.default)({
    ref: ref
  }, inset === 'context' && {
...
process.env.NODE_ENV !== "production" ? ListDivider.propTypes /* remove-proptypes */ = {
   ...
   */
  inset: _propTypes.default /* @typescript-to-proptypes-ignore */.oneOfType([_propTypes.default.oneOf(['gutter', 'startDecorator', 'startContent']), _propTypes.default.string]),
  /**
