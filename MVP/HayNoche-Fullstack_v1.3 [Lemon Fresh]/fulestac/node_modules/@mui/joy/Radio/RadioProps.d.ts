...
export type RadioSlotsAndSlotProps = CreateSlotsAndSlotProps<RadioSlot, {
...
export interface RadioTypeMap<P = {}, D extends React.ElementType = 'span'> {
    props: P & RadioSlotsAndSlotProps & UseSwitchParameters & {
        /**
...
export type RadioProps<D extends React.ElementType = RadioTypeMap['defaultComponent'], P = {
