...
const SelectRoot = styled('div', {
  ...
  return [_extends({
    ...
    '--Select-indicator-color': variantStyle?.backgroundColor ? variantStyle?.color : theme.vars.palette.text.tertiary
  }, ownerState.size === 'sm' && {
...
const SelectListbox = styled(StyledList, {
  ...
  const variantStyle = ownerState.color === 'context' ? undefined : theme.variants[ownerState.variant]?.[ownerState.color];
  return _extends({
    '--focus-outline-offset': `calc(${theme.vars.focus.thickness} * -1)`,
    // to prevent the focus outline from being cut by overflow
    '--List-radius': theme.vars.radius.sm,
    '--List-item-stickyBackground': variantStyle?.backgroundColor || variantStyle?.background || theme.vars.palette.background.popup,
...
const Select = /*#__PURE__*/React.forwardRef(function Select(inProps, ref) {
  ...
  const [SlotRoot, rootProps] = useSlot('root', {
    ...
    getSlotProps: handlers => ({
      onMouseDown: event => {
        if (!listboxOpen && !buttonRef.current?.contains(event.target) && !event.isPropagationStopped()) {
  ...
  return /*#__PURE__*/_jsxs(React.Fragment, {
    ...
    })), result, name && /*#__PURE__*/_jsx("input", {
      type: "hidden",
      name: name,
