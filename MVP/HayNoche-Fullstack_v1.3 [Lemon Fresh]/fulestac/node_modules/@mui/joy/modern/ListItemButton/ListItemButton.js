...
export const StyledListItemButton = styled('div')(({
  ...
  '--List-decorator-color': theme.variants?.[`${ownerState.variant}Disabled`]?.[ownerState.color]?.color
}, {
...
}), _extends({}, theme.variants[ownerState.variant]?.[ownerState.color], !ownerState.selected && {
