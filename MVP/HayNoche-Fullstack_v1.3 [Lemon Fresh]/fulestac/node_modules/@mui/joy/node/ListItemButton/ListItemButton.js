...
const StyledListItemButton = (0, _styles.styled)('div')(({
  ...
  return [(0, _extends2.default)({}, ownerState.selected && {
  ...
  }), (0, _extends2.default)({}, (_theme$variants4 = theme.variants[ownerState.variant]) == null ? void 0 : _theme$variants4[ownerState.color], !ownerState.selected && {
    ...
    [`&.${_listItemButtonClasses.default.disabled}`]: (_theme$variants7 = theme.variants[`${ownerState.variant}Disabled`]) == null ? void 0 : _theme$variants7[ownerState.color]
  }];
});
